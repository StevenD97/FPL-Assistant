...
def load_recent_bootstrap_snapshots(filename="bootstrap_static.json", hours=48):
    ...
    db.read.recent_bootstrap_snapshots for what this actually reads
    ...
    """
    try:
        from db.read import recent_bootstrap_snapshots
...
def compute_price_change_signals(bootstrap, history_snapshots=None):
    ...
    oldest first - e.g. from db.read.recent_bootstrap_snapshots. When
