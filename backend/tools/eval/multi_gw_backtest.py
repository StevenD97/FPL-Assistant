...
Run with: python -m tools.eval.multi_gw_backtest  (from the backend/ folder)
"""
...
from tools.eval.backtest import BOOTSTRAP_FILE, FIXTURES_FILE, MAX_GW, MIN_GW, SEASON, _spearman
